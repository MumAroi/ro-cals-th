...
bon_IGN_DEF_SIZ_SMALL = 360;
bon_IGN_DEF_SIZ_MEDIUM = 361;
bon_IGN_DEF_SIZ_LARGE = 362;
bon_IGN_MDEF_SIZ_SMALL = 363;
...
//Shadow Equip
itm_type_SHADOW_ARMOR = 65;
itm_type_SHADOW_WEAPON = 66;
itm_type_SHADOW_SHIELD = 67;
itm_type_SHADOW_SHOES = 68;
itm_type_SHADOW_EARRING = 69;
itm_type_SHADOW_PENDANT = 70;
...
skill_BS_FULL_ADRENALINE_RUSH = 389;
...
skill_KAG_KUNAI_SPLASH = 726;
skill_KAG_SPIRIT_BREAKER = 727;
skill_KAG_SWIRLING_PETAL = 728;
...
//Rebellion Skills
skill_REB_RICHS_COIN = 745;
skill_REB_FLICKER = 746;
skill_REB_FALLEN_ANGEL = 747;
skill_REB_FIRE_DANCE = 748;
skill_REB_HIT_BARREL = 749;
skill_REB_SHATTERING_STORM = 750;
skill_REB_VANISHING_BUSTER = 751;
skill_REB_SLUG_SHOT = 752;
skill_REB_MASS_SPIRAL = 753;
skill_REB_ANTI_MATERIAL_BLAST = 754;
skill_REB_GODS_HAMMER = 755;
skill_REB_ETERNAL_CHAIN = 756;
skill_REB_QUICK_DRAW_SHOT = 757;
skill_REB_HOWLING_MINE = 758;
skill_REB_DRAGON_TAIL = 759;
skill_REB_FIRE_RAIN = 760;
skill_REB_ROUND_TRIP = 761;
skill_REB_CRIMSON_MARKER = 762;
skill_REB_PLATINUM_ALTAR = 763;
skill_REB_BINDING_TRAP = 764;

//Summoner Skill
skill_SUM_BASIC_SKILL = 765;
skill_SUM_BITE = 766;
skill_SUM_HIDE = 767;
skill_SUM_SCRATCH = 768;
skill_SUM_LOPE = 769;
skill_SUM_STOOP = 770;
skill_SUM_SPRITE_MARBLE = 771;
skill_SUM_SOUL_ATTACK = 772;
skill_SUM_FRESH_SHRIMP = 773;
skill_SUM_BUNCH_OF_SHRIMP = 774;
skill_SUM_TUNA_BELLY = 775;
skill_SUM_TUNA_PARTY = 776;
skill_SUM_POWER_OF_SEA = 777;
skill_SUM_GROOMING = 778;
skill_SUM_PURRING = 779;
skill_SUM_TASTY_SHRIMP_PARTY = 780;
skill_SUM_SPIRIT_OF_SEA = 781;
skill_SUM_SILVERVINE_STEM_SPEAR = 782;
skill_SUM_SILVERVINE_ROOT_TWIST = 783;
skill_SUM_CATNIP_METEOR = 784;
skill_SUM_CATNIP_POWDERING = 785;
skill_SUM_POWER_OF_LAND = 786;
skill_SUM_CHATTERING = 787;
skill_SUM_MEOW_MEOW = 788;
skill_SUM_NYANG_GRASS = 789;
skill_SUM_SPIRIT_OF_LAND = 790;
skill_SUM_PICKY_PECK = 791;
skill_SUM_ARCLOUSE_DASH = 792;
skill_SUM_SCAR_OF_TAROU = 793;
skill_SUM_LUNATIC_CARROT_BEAT = 794;
skill_SUM_POWER_OF_LIFE = 795;
skill_SUM_HISS = 796;
...
var ksBlessingOfTyr = 37;
var ksKillerPotion = 38;
var ksManaPlus = 39;
...
{
var CONST_MAXLVL = 99;
var CONST_MAXLVL_THIRD = 185;
var CONST_MAXLVL_KAGOB_ENOVI = 175;
var CONST_MAXSTAT = 99;
var CONST_MAXSTAT_BABY = 80;
var CONST_MAXSTAT_THIRD = 130;
var CONST_MAXSTAT_THIRD_BABY = 117;
var CONST_MAXSTAT_KAGOB_ENOVI = 130;
}